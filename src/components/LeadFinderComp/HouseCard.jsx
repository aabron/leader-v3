...
<div class="max-w-sm w-[270px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-4">
    <a href="#">
    ...
    <div class="p-3 flex flex-col">
        ...
        <div className="flex flex-row justify-between">
            ...
            <h2 className='text-lg'>{props.loc}</h2>
            </div>
            <h2 className='text-lg'>per {props.ppx}</h2>
